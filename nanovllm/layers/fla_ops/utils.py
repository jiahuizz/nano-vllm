...
# Simplified for nano-vllm: assume NVIDIA CUDA, no AMD/Intel/Hopper-specific paths
device = "cuda"
...
is_nvidia_hopper = False  # L20 is Ada, not Hopper
use_cuda_graph = False
is_gather_supported = hasattr(triton.language, "gather")
is_tma_supported = False  # No Hopper TMA on L20
